package com.example.maps_app.model.BotomNavigation
...
open class BottomNavigation {
    ...
    object Home:BottomNavigation( route = Routes.PantallaMapa.route, icon = Icons.Filled.LocationOn , label = "Location")
